...
<body>
    <form id="form1" runat="server">
        <div class="form-card">
            <h2>Delete Staff</h2>
            <p>Select an employee to deactivate their record in the system.</p>
            ...
            <asp:Panel ID="pnlConfirmForm" runat="server" Visible="False">
                ...
                <p class="warning-text">⚠️ Are you sure you want to remove this employee? They will disappear from active lists, but their record is kept in the database (not permanently deleted) for ticket/history references.</p>
                ...
                <div class="btn-group">
                    <asp:Button ID="btnDelete" runat="server" Text="Remove Employee" CssClass="btn btn-danger" OnClick="btnDelete_Click" OnClientClick="return confirm('Deactivate this employee?');" />
