...
<style>
    ...
    * {
    ...
    body {
        background: radial-gradient(circle at 50% 10%, #0b5558 0%, var(--ocean-deep) 38%, var(--abyss-deep) 100%);
    ...
    .header-icon {
        ...
        font-size: 1.9rem;
        box-shadow: 0 0 20px rgba(255, 107, 122, 0.07);
    }
    ...
    .delete-button:hover {
        ...
        opacity: 0.93;
        box-shadow: 0 5px 18px rgba(255, 92, 108, 0.22);
    }
        ...
        <div class="glass-panel">
            ...
            <div class="button-row">
                ...
                <asp:Button
                    ...
                    OnClientClick="return confirm('Are you sure you want to delete this order? This cannot be undone.');" />
