        ...
        <div class="glass-panel">
            ...
            <div class="orders-grid">
                ...
                <div class="order-card">
                    ...
                    <h3>Add New Order</h3>
                    <p>Create a new restaurant order and record the required order information.</p>
                    <asp:Button
                        ID="Button1"
                        runat="server"
                        Text="Add Order"
                ...
                <div class="order-card">
                    ...
                    <h3>Update Order</h3>
                    <p>Modify an existing order when customer details or order information changes.</p>
                    <asp:Button
                        ID="btnUpdate"
                        runat="server"
                        Text="Update Order"
                ...
                <div class="order-card delete-card">
                    <div class="order-icon">🗑️</div>
                    <h3>Delete Order</h3>
                    <p>Remove an outdated or incorrect restaurant order from the system.</p>
                    <asp:Button
                        ID="btnDelete"
                        runat="server"
                        Text="Delete Order"
                ...
                <div class="order-card">
                    <div class="order-icon">📋</div>
                    <h3>View Orders</h3>
                    <p>Browse restaurant orders and review the current order information stored in AquaCore.</p>
                    <asp:Button
                        ID="btnDisplay"
                        runat="server"
                        Text="Display Orders"
                ...
                <div class="order-card return-card">
                    <div class="order-icon">🐠</div>
                    <h3>Return to Operations</h3>
                    <p>Return to the previous AquaCore operations or management menu.</p>
                    <!-- Added OnClick -->
                    <asp:Button
                        ID="btnReturn"
                        runat="server"
