        ...
        <div class="form-card">
            ...
            <asp:Panel ID="pnlEditForm" runat="server" Visible="False">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtContactDetails" runat="server" CssClass="input-control" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="input-control">
                        ...
                        <asp:ListItem Text="Animal Care" Value="Animal Care" />
                        <asp:ListItem Text="Ticket Sales" Value="Ticket Sales" />
                ...
                <div class="form-group">
                    <label>Role</label>
                    <asp:DropDownList ID="ddlRole" runat="server" CssClass="input-control">
                        <asp:ListItem Text="-- Select Role --" Value="" />
                        <asp:ListItem Text="Keeper" Value="Keeper" />
                        <asp:ListItem Text="Veterinarian" Value="Veterinarian" />
                        <asp:ListItem Text="Cashier" Value="Cashier" />
                        <asp:ListItem Text="Chef" Value="Chef" />
                        <asp:ListItem Text="Waiter" Value="Waiter" />
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtWorkSchedule" runat="server" CssClass="input-control" />
                </div>
