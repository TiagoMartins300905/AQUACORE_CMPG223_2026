    ...
    <div class="portal-wrapper">
        <form id="form1" runat="server" class="glass-card">
            ...
            <div class="card-header">
                <h1>Modify Personnel</h1>
                <p>Select a staff member below to load and update their records.</p>
            </div>
            ...
            <a href="EmployeeManagement.aspx" class="btn-secondary" style="margin-top: 10px;">🏠 Return to Staff Directory</a>
