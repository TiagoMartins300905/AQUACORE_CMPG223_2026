...
<body>
    <form id="form1" runat="server">
        <div class="auto-style2"><h1 class="auto-style3">AquaCore-Feeding Schedule</h1>
            <p class="auto-style3">
                <asp:Label ID="lblHeading" runat="server" Text="Please select a schedule ID to update:"></asp:Label>
            </p>
            <p class="auto-style3">
                <asp:DropDownList ID="ddlScheduleID" runat="server" CssClass="auto-style25" Height="33px" Width="347px">
                    <asp:ListItem>--Select a schedule ID--</asp:ListItem>
                </asp:DropDownList>
            </p>
            <p class="auto-style3">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlScheduleID" ErrorMessage="A schedule ID is required!" InitialValue="--Select a schedule ID--"></asp:RequiredFieldValidator>
            </p>
...
&nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="auto-style22">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnUpdate" runat="server" CssClass="auto-style17" Height="41px" Text="Update Schedule" Width="136px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
